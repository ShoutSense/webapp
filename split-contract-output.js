...
const pathsConfigFile = configDir + 'paths.json';
const ssJavaPlatformDir = jsonfile.readFileSync(pathsConfigFile).ssJavaPlatformDir;
//const ssJavaPlatformDir = process.env.SS_JAVA_PLATFORM_DIR;
const outputWrapperDirFinal = ssJavaPlatformDir + '/src/main/java-autogenerated'; 
...
module.exports = function(callback) {
  // Process and split contracts
  fs.mkdir(outputBuildDir);
